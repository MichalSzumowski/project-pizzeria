/* global Handlebars, utils, */ // npmeslint-disable-line no-unused-vars

{
    ...
    processOrder(){
      ...
      for(let paramId in thisProduct.data.params) {
        ...
        for(let optionId in param.options) {
          ...
          // console.log(optionId, option, !option.default == true);
  ...
  class Cart {
    ...
    add(menuProduct){
      ...
      //console.log('added product', menuProduct, thisCart);
    }
    ...
    update(){
      ...
      if(thisCart.totalNumber != 0){
        ...
        for(let i = 0; i < thisCart.dom.totalPrice.length; i++){
          thisCart.dom.totalPrice[i].innerHTML = 0;
        }
      }
    ...
    remove(removeProduct){
      ...
      const indexOfRemove = thisCart.products.indexOf(removeProduct);
      console.log(removeProduct, indexOfRemove);
      
      thisCart.products.splice(indexOfRemove, 1);

      const removeFromDOM = removeProduct.dom.wrapper;
    ...
    sendOrder(){
      ...
      const payload = {
        ...
        totalPrice: thisCart.totalPrice,//thisCart.dom.totalPrice[0].innerHTML,
        subTotalPrice: thisCart.subTotalPrice,//thisCart.dom.subTotalPrice.innerHTML,
        totalNumber: thisCart.totalNumber,//thisCart.dom.totalNumber.innerHTML,
        deliveryFee: settings.cart.defaultDeliveryFee,//thisCart.dom.deliveryFee.innerHTML,
        products: []
      };
